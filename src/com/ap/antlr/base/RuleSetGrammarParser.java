...
public class RuleSetGrammarParser extends Parser {
	...
	public static class Rule_setContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RuleSetGrammarVisitor ) return ((RuleSetGrammarVisitor<? extends T>)visitor).visitRule_set(this);
	...
	public static class ComparisonExpressionInParenContext extends Comparison_exprContext {
		public TerminalNode LPAREN() { return getToken(RuleSetGrammarParser.LPAREN, 0); }
		public Comparison_exprContext comparison_expr() {
			return getRuleContext(Comparison_exprContext.class,0);
		}
		public TerminalNode RPAREN() { return getToken(RuleSetGrammarParser.RPAREN, 0); }
		public ComparisonExpressionInParenContext(Comparison_exprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RuleSetGrammarListener ) ((RuleSetGrammarListener)listener).enterComparisonExpressionInParen(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RuleSetGrammarListener ) ((RuleSetGrammarListener)listener).exitComparisonExpressionInParen(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RuleSetGrammarVisitor ) return ((RuleSetGrammarVisitor<? extends T>)visitor).visitComparisonExpressionInParen(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Comparison_exprContext comparison_expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				break;
			case 2:
				_localctx = new ComparisonExpressionInParenContext(_localctx);
	...
	public static class Comparison_operandContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RuleSetGrammarVisitor ) return ((RuleSetGrammarVisitor<? extends T>)visitor).visitComparison_operand(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Comp_operatorContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RuleSetGrammarVisitor ) return ((RuleSetGrammarVisitor<? extends T>)visitor).visitComp_operator(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ArithmeticExpressionInParenContext extends Arithmetic_exprContext {
		public TerminalNode LPAREN() { return getToken(RuleSetGrammarParser.LPAREN, 0); }
		public Arithmetic_exprContext arithmetic_expr() {
			return getRuleContext(Arithmetic_exprContext.class,0);
		}
		public TerminalNode RPAREN() { return getToken(RuleSetGrammarParser.RPAREN, 0); }
		public ArithmeticExpressionInParenContext(Arithmetic_exprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RuleSetGrammarListener ) ((RuleSetGrammarListener)listener).enterArithmeticExpressionInParen(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RuleSetGrammarListener ) ((RuleSetGrammarListener)listener).exitArithmeticExpressionInParen(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RuleSetGrammarVisitor ) return ((RuleSetGrammarVisitor<? extends T>)visitor).visitArithmeticExpressionInParen(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ArithmeticExpressionMinContext extends Arithmetic_exprContext {
		public List<Arithmetic_exprContext> arithmetic_expr() {
			return getRuleContexts(Arithmetic_exprContext.class);
		}
		public Arithmetic_exprContext arithmetic_expr(int i) {
		...
		public TerminalNode MIN() { return getToken(RuleSetGrammarParser.MIN, 0); }
		public ArithmeticExpressionMinContext(Arithmetic_exprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RuleSetGrammarListener ) ((RuleSetGrammarListener)listener).enterArithmeticExpressionMin(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RuleSetGrammarListener ) ((RuleSetGrammarListener)listener).exitArithmeticExpressionMin(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RuleSetGrammarVisitor ) return ((RuleSetGrammarVisitor<? extends T>)visitor).visitArithmeticExpressionMin(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private Arithmetic_exprContext arithmetic_expr(int _p) throws RecognitionException {
		...
		try {
			...
			case LPAREN:
				{
				_localctx = new ArithmeticExpressionInParenContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(77);
				match(LPAREN);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						{
						_localctx = new ArithmeticExpressionMinContext(new Arithmetic_exprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_arithmetic_expr);
						setState(93);
						if (!(precpred(_ctx, 4))) throw new FailedPredicateException(this, "precpred(_ctx, 4)");
						setState(94);
	...
	public static class LogicalConstContext extends Logical_entityContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RuleSetGrammarVisitor ) return ((RuleSetGrammarVisitor<? extends T>)visitor).visitLogicalConst(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n